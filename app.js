...
const songDuration = 295;
const animatedObject = document.querySelector('.cd-img-container');
    ...
    if (isPlaying) {
        ...
        countdownInterval = setInterval(function() {
            ...
            if (minutes === 4 && seconds === 55) {
                ...
                document.getElementById("count").innerHTML = "04:55";
                play.style.display = 'block';
                pause.style.display = 'none';
            }
        }, 1000);
...
const fetchLyrics = async()=>{
    ...
    const options = {
        ...
        params: {id: '2266187'},
        headers: {
          'X-RapidAPI-Key': '4b6c9c3372msh5e3cc651363e610p1357cfjsnf044d0b023b4',
